...
<script>
import Newstockformtest from '../components/Newstockformtest.vue'

export default {
  components: { Newstockformtest },
  name: 'StockForm'
}
</script>
...
#employee tr:first-of-type th:first-of-type {
    border-radius:20px 0 0 0;
}

#employee tr:first-of-type th:last-of-type{
